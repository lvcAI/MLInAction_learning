...
def lwlrTestPlot(xArr, yArr, k=1.0):
    ...
    yHat = xCopy * lwlr(xArr, xArr, yArr, k)
    ax.plot(xCopy[:, 1], yHat)  # 这种形式的好像只有在矩阵中才能使用 [:,n] 维数>1



if __name__ == '__main__':
    #testRegression()
    xArr, yArr = loadDataSet("E:\\learning resource\\GitPro\\AiLearning-dev\\db\\8.Regression\\data.txt")
    #lwlrTestPlot(1.0)
    print(lwlr(xArr,xArr,yArr,1.0))
